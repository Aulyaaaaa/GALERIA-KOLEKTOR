        ...
        children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Kurator Terakreditasi · Salon Utama',
          ...
          _group('TOKO', [
            ...
            _MenuItemData(
              ...
              'Data Rekening & Dompet',
              trailingText: 'Rp 184.750.000',
              trailingColor: AppColors.accent,
            ),
            _MenuItemData(
              Icons.inventory_2_outlined,
              'Pengaturan Pengiriman & Packing',
            ),
            _MenuItemData(
        ...
        children: [
          ...
          if (d.badge != null)
            Container(
              ...
              decoration: BoxDecoration(
                color: (d.badgeColor ?? AppColors.accent).withValues(
                  alpha: 0.15,
                ),
              ...
              child: Text(
                ...
                style: AppTextStyles.labelSm.copyWith(
                  fontSize: 10,
                  color: d.badgeColor ?? AppColors.accent,
                ),
              ),
            ),
          const SizedBox(width: 4),
