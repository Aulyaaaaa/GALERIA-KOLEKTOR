...
class MemverifikasiKeaslianScreen extends StatefulWidget {
  ...
  @override
  State<MemverifikasiKeaslianScreen> createState() =>
      _MemverifikasiKeaslianScreenState();
}

class _MemverifikasiKeaslianScreenState
    extends State<MemverifikasiKeaslianScreen>
            ...
            children: [
                ...
                child: Column(
                  children: [
                    _stepRow(
                      ...
                      subtitle:
                          'Mendeteksi kemiripan visual, komposisi, & palet karya lain',
                      status: 'Selesai',
                    ...
                    _stepRow(
                      ...
                      subtitle:
                          'Mendeteksi artefak sintetis dan pola piksel generatif AI',
                      status: 'Memindai...',
                    ...
                    _stepRow(
                      ...
                      subtitle:
                          'Mengagregasi laporan kurasi dan kesimpulan orisinalitas',
                      status: 'Menunggu',
              ...
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(
                    'Proses ini biasanya memakan waktu kurang dari 30 detik.',
              ...
              Text(
                'Harap jangan menutup aplikasi selama enkripsi sertifikat berlangsung.',
                textAlign: TextAlign.center,
                style: AppTextStyles.overline.copyWith(
                  color: AppColors.muted,
                  fontSize: 9,
