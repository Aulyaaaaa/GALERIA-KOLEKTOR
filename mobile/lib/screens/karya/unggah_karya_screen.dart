...
class _UnggahKaryaScreenState extends State<UnggahKaryaScreen> {
          ...
          children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 6),
                      Text(
                        'Integritas & Legalitas Balai Lelang',
                  ...
                  CheckboxListTile(
                    ...
                    onChanged: (v) =>
                        setState(() => _originalChecked = v ?? false),
                    controlAffinity: ListTileControlAffinity.leading,
                    contentPadding: EdgeInsets.zero,
                    dense: true,
                    activeColor: AppColors.primary,
                    title: Text(
                      'Saya menyatakan karya ini asli buatan saya sendiri',
                      style: AppTextStyles.bodySm.copyWith(
                  ...
                  CheckboxListTile(
                    ...
                    activeColor: AppColors.primary,
                    title: Text(
                      'Saya menyetujui Syarat Kurasi & Penjualan Lelang GALERIA',
                      style: AppTextStyles.bodySm.copyWith(
                        fontWeight: FontWeight.w600,
                      ),
                    ),
                    subtitle: Text(
                      'Termasuk klausul inspeksi fisik sebelum pengiriman ke kolektor.',
                      style: AppTextStyles.bodySm.copyWith(fontSize: 11),
                    ),
                  ),
                ],
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 6),
                Text(
                  'ENKRIPSI PROVENANSI BALAI LELANG GALERIA',
  ...
  Widget _photoThumb(String asset, {String? label, bool deletable = false}) =>
      Stack(
        children: [
          ClipRRect(
            borderRadius: BorderRadius.circular(AppRadius.md),
          ...
          Positioned(
            ...
            child: CircleAvatar(
              ...
              child: Icon(
                deletable ? Icons.delete_outline : Icons.edit_outlined,
                size: 14,
              ),
            ),
          ),
