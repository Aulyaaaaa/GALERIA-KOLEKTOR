...
class KaryaDitolakScreen extends StatelessWidget {
  const KaryaDitolakScreen({
    super.key,
    required this.onBack,
    required this.onAjukanBanding,
  });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      'PELANGGARAN HAK CIPTA & DUPLIKASI',
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            'Batas Maksimal Orisinalitas Terlampaui',
                            style: AppTextStyles.labelSm.copyWith(
                              color: AppColors.error,
                              fontSize: 10,
                            ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Merasa ini karya orisinal milikmu?',
                          style: AppTextStyles.labelMd,
                        ),
            ...
            Center(
              child: Text(
                'ID Sengketa: #REJ-2025-9412X · Perlindungan Hak Kekayaan Intelektual GALERIA',
                textAlign: TextAlign.center,
                style: AppTextStyles.overline.copyWith(
                  fontSize: 8.5,
