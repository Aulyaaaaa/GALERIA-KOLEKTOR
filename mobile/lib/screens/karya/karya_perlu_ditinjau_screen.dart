    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.md),
          Text(
            'Ditemukan Kemiripan Dengan Karya Lain',
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Karya terdaftar dengan kecocokan pola tertinggi',
                    style: AppTextStyles.bodySm.copyWith(
                      color: AppColors.muted,
                    ),
                  ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(
                      'Dukungan Kurator 24/7 · Balai Lelang GALERIA',
                      style: AppTextStyles.bodySm.copyWith(
                        color: AppColors.muted,
                      ),
                    ),
                ...
                Text(
                  'ID TIKET TELAAH: #REV-2024-8902B',
                  style: AppTextStyles.overline.copyWith(
                    fontSize: 8.5,
